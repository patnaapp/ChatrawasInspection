...
public class MultiplePhotoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // img_threshing = (ImageView) findViewById(R.id.During_Threshing);
        ...
        Cursor cursor = db
                .rawQuery("SELECT Principal_Photo,Teacher_Photo,School_Pic1,School_Pic2 FROM Principal_Details where DiseCode =?", new String[]{String.valueOf(PID)});


        if (cursor.moveToNext()) {

            if (!cursor.isNull(0)) {
                byte[] imgData = Base64.decode(cursor.getString(cursor.getColumnIndex("Principal_Photo")), Base64.DEFAULT);
            ...
            if (!cursor.isNull(1)) {
                byte[] imgData = Base64.decode(cursor.getString(cursor.getColumnIndex("Teacher_Photo")), Base64.DEFAULT);
            ...
            if (!cursor.isNull(2)) {
                byte[] imgData = Base64.decode(cursor.getString(cursor.getColumnIndex("School_Pic1")), Base64.DEFAULT);
...
//                        imgData.length);
//                if (bmp != null) {
//                    img_threshing.setImageBitmap(Utiilties.GenerateThumbnail(bmp,
//                            ThumbnailSize, ThumbnailSize));
...
//            }
            ...
            if (!cursor.isNull(3)) {
                ...
                byte[] imgData = Base64.decode(cursor.getString(cursor.getColumnIndex("School_Pic2")), Base64.DEFAULT);
                // byte[] imgData = cursor.getBlob(cursor.getColumnIndex("Photo3"));
    ...
    public void onClick(View view) {
        if (view.equals(btnOk)) {
            if (imageData1 == null && imageData2 == null && imageData3 == null  && imageData4 == null && purpose.equals("isEdit")) {
                ...
                Intent iUserHome = new Intent(MultiplePhotoActivity.this, Activity_Hostel_Home.class);
            ...
            switch (i) {
                case 0:
                    ...
                    if (imageData1 != null) {
                        ...
                        values.put("Principal_Photo", str_img1);
                        ...
                        long c = db.update("Principal_Details", values, "DiseCode=?", whereArgs);
                        if (c > 0) {
                ...
                case 1:
                    if (imageData2 != null) {
                        ...
                        values.put("Teacher_Photo", str_img2);
                        whereArgs = new String[]{String.valueOf(PID)};
                        long c = db.update("Principal_Details", values, "DiseCode=?", whereArgs);
                ...
                case 2:
                    if (imageData3 != null) {
                        ...
                        values.put("School_Pic1", str_img3);
                        whereArgs = new String[]{String.valueOf(PID)};
                        long c = db.update("Principal_Details", values, "DiseCode=?", whereArgs);
                        if (c > 0) {
                ...
                case 3:
                    if (imageData4 != null) {
                        ...
                        values.put("School_Pic2", str_img4);
    ...
    public void onBackPressed() {
        ...
        if (cursor.moveToNext()) {
            ...
            if (!cursor.isNull(0)) {
                ...
                byte[] imgData = cursor.getBlob(cursor.getColumnIndex("Principal_Photo"));
                if (imgData != null) {
                    finish();
                }
            } else {
